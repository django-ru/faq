...
- [MVC и его применение в Django](https://www.youtube.com/watch?v=HpL6ymFEuu4) - Видео объясняет паттерн MVC и предлагает удобный способ использовать его в Django для отделения бизнес-логики от представления данных (моделей). 🇷🇺
